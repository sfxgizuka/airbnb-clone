...
const Header = ({ placeholder}: HeaderProps) => {
    ...
    const handleDateSelect = (ranges:any):void => {
        ...
        { searchInput && (
            <div className='flex flex-col col-span-3 mx-auto'>
                ...
                <div className='flex items-center border-b mb-4'>
                    ...
                    <input type="number" className='w-12 pl-2 text-lg outline-none text-red-400' value={noOfGuests} onChange={(e:any)=> setNoOfGuests(e.target.value)} min={1}/>
                </div>
                <div className='flex'>
